/********************************************************
Anderson Lima - andermarce@gmail.com
Get Price List DEX
2020-09-14 - v 0.1 
...
const UNISWAP_FACTORY_ADDRESS = "0xc0a47dfe034b400b47bdad5fecda2621de6c4d95"; // v1
//const UNISWAP_FACTORY_ADDRESS = "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"; // v2
  ...
  console.table([
    {
      ...
      Timestamp: moment().tz("America/Fortaleza").format(),
    },
  ]);
}
...
async function monitorPrice() {
  ...
  console.log("Checking prices ( 500ms )");
  ...
  try {
    ...
    await checkPair({
      inputTokenSymbol: "ETH",
      inputTokenAddress: "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
      outputTokenSymbol: "sUSD",
      outputTokenAddress: "0x57ab1ec28d129707052df4df418d58a2d46d5f51",
      inputAmount: web3.utils.toWei("1", "ETHER"),
    });
...
// Check markets every n mili/seconds
const POLLING_INTERVAL = process.env.POLLING_INTERVAL || 500; // 500 MiliSeconds
